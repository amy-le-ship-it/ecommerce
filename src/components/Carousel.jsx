...
import "../index.css"; // make sure Tailwind + slick overrides are here
        ...
        {data && data.length > 0 ? (
          data.slice(0, 7).map((item, index) => (
            <div key={index} className="h-full">
              <div className="bg-gradient-to-r from-[#0f0c29] via-[#302b63] to-[#24243e] h-full w-full flex flex-col md:flex-row gap-10 justify-center items-center px-4">
